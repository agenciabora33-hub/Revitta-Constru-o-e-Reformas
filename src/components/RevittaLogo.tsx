...
export const RevittaLogo: React.FC<RevittaLogoProps> = ({ 
  ...
  return (
    <div className={`flex items-center gap-2.5 sm:gap-3 select-none ${className}`}>
      {/* Visual Architectural Monogram Mark from official favicon */}
      <div className="relative flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-indigo-950 shadow-md shadow-indigo-950/20 shrink-0 overflow-hidden border border-indigo-700/40">
        <img
          src="/favicon.png"
          alt="Ícone Revitta"
